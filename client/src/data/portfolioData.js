...
export const projects = [
  {
    ...
    description:
      "Web platform connecting users, businesses, and law firms to post legal issues and hire lawyers, with secure direct chat, a business portal for managing legal matters, and cross-platform access.",
  ...
  },
  {
    ...
    description:
      "React-based booking platform for a luxury yacht and boat rental company in Abu Dhabi, featuring tiered memberships, real-time boat bookings, PayPal/card payments, and bilingual (English/Arabic) support.",
    tech: ["React 18", "i18next",],
  ...
  },
  {
    ...
    description:
      "Cross-platform digital menu and ordering solution for Omniyat's sales gallery, letting guests scan a QR code to browse menus, place orders, call a teaboy, and track order history in real time.",
  ...
  },
  {
    ...
    name: "Nahham Web",
    description:
      "Bilingual (Arabic/English) talent marketplace platform connecting companies with creative talents across the UAE, with OTP-based authentication, Stripe payment integration, and end-to-end project/offer management.",
